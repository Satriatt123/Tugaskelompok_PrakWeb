                ...
                <div class="col-md-5">
                    <div class="glass-card p-5">
                        ...
                        <form action="proses_login.php" method="POST">
                            ...
                            <button type="submit" class="btn btn-info w-100 fw-bold text-white py-2 shadow">LOGIN</button>
                            <div class="text-center mt-4">
                                <p class="small text-light">Belum Punya Akun ? <a href="register.php" class="text-info fw-bold text-decoration-none">Register di sini</a></p>
                            </div>
                        </form>
                    </div>
                </div>
